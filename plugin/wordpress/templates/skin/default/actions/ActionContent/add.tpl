...
<form action="" method="POST">
	...
	<p><label for="content_name">{$aLang.plugin.wordpress.content_field_name}:</label><br />
	<input type="text" id="content_name" name="content_name" value="{$_aRequest.content_name}" class="input-wide" /></p>
					
	<p><label for="content_title">{$aLang.plugin.wordpress.content_field_title}:</label><br />
	<input type="text" id="content_title" name="content_title" value="{$_aRequest.content_title}"  class="input-wide" /></p>
											
	<label for="content_content">{$aLang.plugin.wordpress.content_field_content}:</label>
	...
	{$aLang.plugin.wordpress.content_field_is_php}</label></p>
	
				
	<input type="submit" name="submit_content_save" value="{$aLang.plugin.wordpress.content_submit_save}" />
	<input type="submit" name="submit_content_cancel" value="{$aLang.plugin.wordpress.content_submit_cancel}" onclick="window.location='{router page='contentany'}'; return false;" />
